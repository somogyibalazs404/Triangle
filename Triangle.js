...
let ac = a + c;
if (ab > c && cb > a && ac > b) {
    document.write(`Your triangle is ${a} x ${b} x ${c}, it is an existing triangle.`);
}
else if (ab > c && cb > a && ac < b) {
    document.write(`Your triangle is ${a} x ${b} x ${c}, it's "b" side is too long so it does not exist, because "a" and "b" is ${ac} which is shorter than ${b}`);
}
else if (ab > c && cb < a && ac > b) {
    document.write(`Your triangle is ${a} x ${b} x ${c}, it's "a" side is too long so it does not exist, because "a" and "b" is ${cb} which is shorter than ${a}`);
}
else if (ab < c && cb > a && ac > b) {
